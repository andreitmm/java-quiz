...
<body>
<h3 align="right"><a href='${pageContext.request.contextPath}/exam/report/generatePDF' target="_blank">Download this report as PDF</a></h3><br>
...
<c:if test='${q.userSelected != -1}'>
<font color="#1334F1">You Chose : ${q.userSelected}</font><br/>
</c:if>
<br/>
